  ...
  const KNOWLEDGE_BASE = [
    {
      ...
      response: "🏹 **EklavyaX** is a premier gamified STEM learning platform. Inspired by Eklavya, who mastered archery through sheer dedication, it bridges rural students and real teachers with interactive labs, streak rewards, EduCoins, and AI tutors!"
    },
    {
  ...
  widgetContainer.innerHTML = `
    ...
    <div id="eklavyaChatWindow" class="eklavya-chat-window">
      ...
      <div class="eklavya-chat-footer">
        ...
        <div class="eklavya-footer-credit">EklavyaX • Gamified STEM Platform</div>
      </div>
    </div>
