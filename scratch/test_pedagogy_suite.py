...
def run_tests():
    ...
    html_checks = [
        ("frontend/teacher/analytics.html", ["Doubt & Struggle Heatmap", "High Struggle", "Schedule 15-Min Remedial", "Assign Targeted Practice"]),
        ("frontend/student/eklavyalens.html", ["EklavyaLens", "Indus", "Ganga", "Himalayas", "Civilization", "Terrain"]),
        ("frontend/student/pyq_arena.html", ["PYQ Arena", "JEE Main", "NEET", "CBSE Class 12", "timerDisplay"]),
        ("frontend/student/bookmarks.html", ["Revision Bookmarks Vault", "Practice My Bookmarks", "Formulas"]),
        ("frontend/student/mindmaps.html", ["Concept Dependency Mind Map", "Interactive Concept Network", "Prerequisite Flow"]),
        ("frontend/student/explore_courses.html", ["Classes 6", "EklavyaLens Maps", "Social Science (EklavyaLens)", "All Grades"]),
        ("frontend/student/student_dashboard.html", ["EklavyaLens Maps", "PYQ Arena", "Mind Maps", "Revision Vault", "Silently Struggling Detector", "Revision Radar"]),
        ("frontend/student/quiz.html", ["EklavyaALERT", "Prerequisite Dependency", "bookmarkCurrentQuestion"]),
    ]
